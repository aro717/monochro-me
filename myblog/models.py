...
class Thumbnail(models.Model):
    image = models.ImageField(upload_to='', unique=True)
...
class Post(models.Model):
    ...
    # old_thumbnail = models.ImageField('旧サムネイル', blank=True, null=True)
    thumbnail = models.ForeignKey(Thumbnail, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='サムネイル')
